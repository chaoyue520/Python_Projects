...
echo "<table border=1>" 
cat /home/fsg/wenchao_auto_mail/yewu/data/data_index_transform.txt|awk -v a="<tr><td align=center>" -v b="</td><td align=center>" -v c="</td></tr>" -F'\t' '{printf a}''{for(i=1;i<=(NF-1);i++) printf $i b}''{printf $NF c}'
echo "</table>"


echo "<p><strong> 二. Account in bucket  在库笔数 </strong></p>" 
echo "<table border=1>" 
cat /home/fsg/wenchao_auto_mail/yewu/data/zaiku_bid_odus.txt|awk -v a="<tr><td align=center>" -v b="</td><td align=center>" -v c="</td></tr>" -F'\t' '{printf a}''{for(i=1;i<=(NF-1);i++) printf $i b}''{printf $NF c}'
echo "</table>"

echo "<p><strong> 三. Balance in bucket 在库金额 </strong></p>" 
echo "<table border=1>" 
cat /home/fsg/wenchao_auto_mail/yewu/data/zaiku_balance_odus.txt|awk -v a="<tr><td align=center>" -v b="</td><td align=center>" -v c="</td></tr>" -F'\t' '{printf a}''{for(i=1;i<=(NF-1);i++) printf $i b}''{printf $NF c}'
echo "</table>"

echo "<p><strong> 四. Total Account percentage 账户逾期率 </strong></p>" 
echo "<table border=1>" 
cat /home/fsg/wenchao_auto_mail/yewu/data/Bid_odus_ratio.txt|awk -v a="<tr><td align=center>" -v b="</td><td align=center>" -v c="</td></tr>" -F'\t' '{printf a}''{for(i=1;i<=(NF-1);i++) printf $i b}''{printf $NF c}'
echo "</table>"

echo "<p><strong> 五. Total balance percentage 金额逾期率 </strong></p>" 
echo "<table border=1>" 
cat /home/fsg/wenchao_auto_mail/yewu/data/Banlance_odus_ratio.txt|awk -v a="<tr><td align=center>" -v b="</td><td align=center>" -v c="</td></tr>" -F'\t' '{printf a}''{for(i=1;i<=(NF-1);i++) printf $i b}''{printf $NF c}'
echo "</table>"
